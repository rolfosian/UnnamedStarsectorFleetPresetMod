...
public class UiConfig {
    ...
    static {
        ...
        CONFIRM_DIALOG_HEIGHT_DIVISOR = CONFIRM_DIALOG_HEIGHT_DIVISOR_ * 1.3f;

        PANEL_WIDTH_SUBTRACTOR = PANEL_WIDTH_SUBTRACTOR_ * 1.3f;
        PANEL_HEIGHT_SUBTRACTOR = PANEL_HEIGHT_SUBTRACTOR_ * 1.3f;

        NAME_COLUMN_WIDTH_DIVISOR = NAME_COLUMN_WIDTH_DIVISOR_;
        SHIP_COLUMN_WIDTH_DIVISOR = SHIP_COLUMN_WIDTH_DIVISOR_;
        // public static final float TABLE_HEADER_Y_OFFSET_PERCENT_BTM;
        // public static final float TABLE_HEADER_Y_OFFSET_PERCENT_TOP;
        SHIPLIST_PANEL_HEIGHT_SUBTRACTOR = SHIPLIST_PANEL_HEIGHT_SUBTRACTOR_ * 5f;
        SHIPLIST_PANEL_PADDING_DIVISOR = SHIPLIST_PANEL_PADDING_DIVISOR_ * 1.3f;
        SHIPLIST_SCALE = SHIPLIST_SCALE_;
        SHIPLIST_Y_OFFSET_MULTIPLIER = SHIPLIST_Y_OFFSET_MULTIPLIER_ + 100f;
